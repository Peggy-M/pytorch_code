...
import numpy as np
from CustomMNISTDataset import CustomMNISTImageDataset
...
train_datasets = CustomMNISTImageDataset(
    data_dir="./mist_images", train=True, transfrom=transform
)

test_datasets = CustomMNISTImageDataset(
    data_dir="./mist_images", train=False, transfrom=transform
)
